...
namespace NEA_Project
{
    partial class login_page
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Errorlog.Location = new System.Drawing.Point(528, 121);
			this.Errorlog.Name = "Errorlog";
			this.Errorlog.Size = new System.Drawing.Size(80, 13);
			this.Errorlog.TabIndex = 9;
			this.Errorlog.Text = "Temp Error Log";
			this.Errorlog.Click += new System.EventHandler(this.label1_Click_1);
			// 
			// sql_test
			// 
